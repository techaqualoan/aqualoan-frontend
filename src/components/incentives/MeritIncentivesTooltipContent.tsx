  ...
  return (
    ...
    >
      ...
      <Typography variant="caption" color="text.secondary" mb={3}>
        <Trans>
          This is a program initiated and implemented by the decentralised Aqualoan community.
          Aqualoan Labs does not guarantee the program and accepts no liability.
        </Trans>{' '}
        <Link
