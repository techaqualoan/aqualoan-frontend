  ...
  return (
    <>
      <BasicModal open={open} setOpen={close}>
        ...
        <Typography sx={{ my: 6 }}>
          <Trans>
            The Aqualoan Balancer Pool Token (ABPT) is a liquidity pool token. You can receive ABPT
            by depositing a combination of AQUA + wstETH in the Balancer liquidity pool. You can
