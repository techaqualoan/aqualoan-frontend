  ...
  return (
    <>
      ...
      <Typography variant="caption" color="text.secondary" mb={6}>
        <Trans>
          Users who stake AQUA in Safety Module (i.e. stkAAVE holders) receive a discount on GHO
  ...
  return (
    <Box sx={{ flexGrow: 1, minWidth: 0, maxWidth: '100%', width: '100%' }}>
      ...
      <Typography variant="caption" color="text.secondary">
        <Trans>
          Discount parameters are decided by the Aqualoan community and may be changed over time.
