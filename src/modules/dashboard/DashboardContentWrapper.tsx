...
import { Box, Button, useMediaQuery, useTheme } from '@mui/material'; //Typography,
...
import { AUTH } from 'src/utils/mixPanelEvents'; //, DASHBOARD
...
export const DashboardContentWrapper = ({ isBorrow }: DashboardContentWrapperProps) => {
  ...
  // const [, setCurrentMarket] = useRootStore((store) => [
  //   store.currentMarket,
