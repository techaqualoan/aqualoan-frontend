      ...
      titleComponent={
        <Box mb={4}>
          ...
          <Typography sx={{ color: '#8E92A3', maxWidth: '824px' }}>
            <Trans>
              Aqualoan is a fully decentralized, community governed protocol by the AQUA
              token-holders. AQUA token-holders collectively discuss, propose, and vote on upgrades
              to the protocol. AQUA token-holders (Ethereum network only) can either vote themselves
