            ...
            {!isAaveSelfDelegated && (
              ...
              >
                <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                  <TokenIcon symbol="AQUA" sx={{ width: 16, height: 16 }} />
    ...
    <Paper sx={{ mt: 2 }}>
      <Box sx={{ px: 6, pb: 6, pt: 4 }}>
        ...
        <Typography typography="description" sx={{ mt: 1 }} color="text.secondary">
          <Trans>
            Use your AQUA, stkAAVE, or aAave balance to delegate your voting and proposition powers.
        ...
        {disableButton ? (
          <Typography variant="description" color="text.muted" mt={6}>
            <Trans>You have no AQUA/stkAAVE/aAave balance to delegate.</Trans>
          </Typography>
        ) : (
          <>
            <DelegatedPower
