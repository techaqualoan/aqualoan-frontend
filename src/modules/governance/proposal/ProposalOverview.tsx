            ...
            <>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Button
                  ...
                  href={`https://hey.xyz/?url=${window.location.href}&text=Check out this proposal on aave governance 👻👻 - ${proposal.subgraphProposal.proposalMetadata.title}&hashtags=Aqualoan&preview=true`}
                  startIcon={
                    <LensIcon
